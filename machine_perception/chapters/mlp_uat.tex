...
\begin{definition}[UAT]
    \(\sigma\) any act-f. bounded + cont. \(I_m\) \(m\)-dim hyperc and space of real cont. f. on \(I_m\) is \(C(I_m)\). Then given \(\epsilon > 0\), \(N\) int, \(v_i, b_i \in \R\) and \(\w_i \in \R^m\) for \(i \in [N]\), then \(\forall f \in C(I_m) \forall \x \in I_m:\)
