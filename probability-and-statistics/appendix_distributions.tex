...
\begin{lemma}
  \(X \sim \Normal(0, 1), \, Y \sim \chi^2(k) \, \text{ind.}\implies \frac{X}{\sqrt{\frac{1}{k}Y}} \sim t(k)\)
\end{lemma}
...
\begin{theorem*}[Distribution statements (\(X_1, \ldots, X_n\) iid. \(\sim \Normal(\mu, \sigma^2)\))]
  \begin{itemize}
    ...
    \item \(\frac{\bar{X_n} - \mu}{S / \sqrt{n}} = \frac{\frac{\bar{X_n} - \mu}{\sigma / \sqrt{n}}}{\sqrt{\frac{1}{n-1} \frac{n-1}{\sigma^2}S^2}} \sim t(n-1)\)
  \end{itemize}
\end{theorem*}
