...
% Chapters
\input{the_digital_image.tex}
\input{image_segmentation.tex}
\input{image_filtering.tex}
\input{image_features.tex} \pagebreak
\input{fourier_transform.tex}
\input{unitary_transforms.tex}
\input{image_compression.tex}
\input{optical_flow.tex}
\input{video_compression.tex}
\input{convolutional_neural_networks.tex}
\input{radon_transform.tex}
